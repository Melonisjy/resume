        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-2.5 print:flex print:flex-row print:gap-1.5">
          {t.blogLinks.map((item, i) => (
            <motion.a
              ...
              className="group flex min-w-0 flex-1 flex-col rounded border border-[#ddd] bg-[#fafaf8] px-2.5 py-2 text-[13px] transition-colors duration-150 hover:border-neutral-500/35 print:px-1.5 print:py-1 print:text-xs dark:border-[#333] dark:bg-[#161616] dark:hover:border-neutral-400/40"
            >
              <span
